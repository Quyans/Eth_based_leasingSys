        ...
        <div class="bk":style="note2">
         <div class="fir">
            <div class="phone">
                ...
                <div class="h-info">
                    省份:<span style="margin-left:50px">{{provi}}</span>
                </div>
                <div class="h-info">
                    城市:<span style="margin-left:50px">{{city}}</span>
                </div>
                <div class="h-info">
                    市区:<span style="margin-left:50px">{{sector}}</span>
                </div>
                <div class="h-info">
                    小区:<span style="margin-left:50px">{{commu_name}}</span>
                </div>
                <div class="h-info">
                    具体地址:<span style="margin-left:50px">{{specific_location}}</span>
                </div>
                <div class="h-info">
                    楼层:<span style="margin-left:50px">{{floor}}</span>
                </div>
                <div class="h-info">
                    房型:<span style="margin-left:50px">{{house_type}}</span>
                </div>
                <div class="h-info">
                    房子可用:<el-input
                        placeholder="请输入内容"
